...
# for file in [x[-1] for x in os.walk(image_folder)][0]:
erros = 0
...
for i,batch in enumerate(test_data):
    ...
    try:
        ...
        # explanation = explainer.explain_instance(image[0][0].asnumpy().transpose().astype(int), classifier_fn, top_labels=5, hide_color=0, num_samples=1000)
